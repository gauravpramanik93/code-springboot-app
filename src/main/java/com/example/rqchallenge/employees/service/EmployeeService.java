...
public class EmployeeService {
    ...
    public List<Employee> getAllEmployees(){
        ...
        try {
            ...
            log.error("Error occurred while retrieving employees");
    ...
    public List<Employee> getEmployeesByNameSearch(String name) {
        ...
        if(employeeList == null || employeeList.isEmpty()){
            log.debug("Fetching the mock employees from raw data.");
    ...
    public Employee getEmployeeById(String id) {
        ...
        try {
            ...
            log.error("Error while retrieving employee by id " + id);
    ...
    public Integer getHighestSalary() {
        ...
        return ParserUtil.getHighestSalary(getAllEmployees());
    }
    ...
    public List<String> getTopHighestEarningEmployeeNames() {
        ...
        try {
            ...
            if(employeeList == null || employeeList.isEmpty()){
                log.warn("Fetching top 10 highest earning mock employees from raw data.");
                throw new Exception();
            }
            return employeeList;
        } catch (Exception ex){
    ...
    public Employee createEmployee(Map<String, Object> employeeInput) {
        ...
        try {
            ...
            log.error("Error occurred while creating employee object with name " + employeeInput.get(Constants.EMPLOYEE_NAME));
    ...
    public String deleteEmployee(String id) {
        ...
        try {
            ...
            log.error("Error occurred while deleting the employee with id {}", id);
